...
function lakukanLooping(arrPegawai) {
  ...
  */
  ...
  else if (jumlahWanita > jumlahPria) komentar = "Jumlah Wanita lebih banyak dari Pria"
  else if (jumlahWanita == jumlahPria) komentar = "Jumlah Pria dan Wanita berimbang"
